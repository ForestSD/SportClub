...
public class AddMemberActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void saveMember(){
        ...
        if(TextUtils.isEmpty(firstName)){
            ...
            Toast.makeText(this, "Введите спортивное увличение", Toast.LENGTH_LONG).show();
            return;
        ...
        if(currentMemberUri == null){
            ...
            if(uri == null){
                Toast.makeText(this, "Вставка данных в таблицу не удалась", Toast.LENGTH_LONG).show();
            } else {
            ...
            if(rowsChanged == 0){
                Toast.makeText(this, "Сохранение данных не удалось", Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(this, "Данные успешно обновленны!", Toast.LENGTH_LONG).show();
            }
    ...
    private void showDeleteMemberDialog(){
        ...
        builder.setMessage("Вы действительно хотите удалить этого полозователя?");
    ...
    private void deleteMember(){
        if(currentMemberUri != null){
            int rowsDeleted = getContentResolver().delete(currentMemberUri,
                    null ,null);
            if(rowsDeleted == 0){
                Toast.makeText(this, "Удаление данных члена клуба не удалось", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Удаление члена клуба прошло успешно!", Toast.LENGTH_SHORT).show();
            }
